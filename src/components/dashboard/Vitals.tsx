...
const VitalsWidget = () => {
        ...
        return (
            <div className="justify-center flex-1 space-x-4 flex flex-row">
                ...
                <div className="flex flex-col">
                    <h1 className="text-center text-lg font-semibold border-b-2 border-gray-200">{label}</h1>
    ...
    const VitalsRow = ({left, right}: {left: VitalsInfo, right?: VitalsInfo}) => {
        return (
            <li className="py-2 first:pt-0 justify-center divide-x-2 divide-gray-300 flex flex-row">
                <VitalsCell {...left} />
    ...
    return <>
        <div className="w-full">
            <div className="h-full bg-slate-100 p-2 flex flex-col">
                <div className="grow">
                    <ul className="w-full divide-y-2 divide-gray-300">
                        {vitalsRows}
                    </ul>
                </div>

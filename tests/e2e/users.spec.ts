...
test.describe("users page", () => {
  ...
  test.describe("create user", () => {
    adminTest(
      'dipslays "Add User" modal when "Add User" button is clicked',
      async ({ page }) => {
  ...
  test.describe("edit user", () => {
    adminTest(
      'dipslays "Edit User" modal when "Edit" button is clicked',
      async ({ page }) => {
  ...
  test.describe("delete user", () => {
    adminTest(
      'dipslays "Delete User" modal when "Delete" button is clicked',
      async ({ page }) => {
